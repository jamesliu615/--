        ...
        <body>
          ...
          <script>
            ...
            async function queryAttendance() {
              ...
              const selectedStudentId = selectedOption.value;
              const selectedStudentName = selectedOption.text.split(" - ")[1];

              try {

                const response = await axios.get('學生點名查詢.php', {
                  params: {
                    studentId: selectedStudentId,
                    studentName: selectedStudentName
                  }
                });
                let resultString = JSON.stringify(response.data, null, 2);
                resultString = resultString.replace(/\\r\\n/g, ""); // 替換掉所有的\r\n為<br>
                document.getElementById('attendanceResult').innerHTML = resultString;
              } catch (error) {
                console.error(error);
                document.getElementById('attendanceResult').innerHTML = '查詢出錯';
              }
            }
          </script>
          <div class="form-group">
            ...
            <br><br>
            <button onclick="queryAttendance()">查詢出席狀態</button>
          </div>
